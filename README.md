...
[![arXiv](https://img.shields.io/badge/arXiv-2601.17230-b31b1b.svg)](https://arxiv.org/abs/2601.17230) [![HuggingFace Dataset](https://img.shields.io/badge/🤗%20HuggingFace-Dataset-orange)](https://huggingface.co/datasets/IDIRLab/CaseFacts) [![License: CC BY-NC 4.0](https://img.shields.io/badge/License-CC%20BY--NC%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by-nc/4.0/)
...
The full train and test datasets can be downloaded from [HuggingFace](https://huggingface.co/datasets/IDIRLab/CaseFacts): `IDIRLab/CaseFacts`.
